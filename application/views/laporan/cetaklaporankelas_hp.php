  ...
  <section class="sheet padding-10mm">
    <table>
      <tr>
        ...
        <td><h3 style="font-family:Tahoma">DAFTAR TUNGGAKAN KELAS <?php echo $kelas; ?><br>TAHUN AJARAN <?php echo $tahunajaran; ?> </h3></td>
      </tr>
    </table>
	...
	<th>Nama Ortu</th>
	  ...
	  <td bgcolor="<?php echo $bgcolor; ?>"><?php echo $c->namaorgtua; ?></td>
          ...
          if($lunas=="-"){
              ...
              <td align="right" bgcolor="<?php echo $bgcolor; ?>"><strong><?php  echo number_format($tsumnow,0,',','.');?></td>
    			...
    			?>
    				<td align="right" bgcolor="<?php echo $bgcolor; ?>"><strong><?php  echo number_format($sumnow,0,',','.');?></strong></td>
            <td align="right" bgcolor="<?php echo $bgcolor; ?>"><strong><?php  echo number_format($tsumnow,0,',','.');?></strong></td>
    			<?php
    			}
      ...
      <?php
        ...
        $total = $total + $sumnow;
        $ttotal = $ttotal + $tsumnow;
        $no++;
        }
      ?>
      <tr>
        <td colspan="8" bgcolor="#024a75" style="color:white;" align="center"><strong>TOTAL</strong></td>
        <td align="right" bgcolor="#024a75" style="color:white;"  ><strong><?php  echo number_format($total,0,',','.');?></strong></td>
        <td align="right" bgcolor="#024a75" style="color:white;"  ><strong><?php  echo number_format($ttotal,0,',','.');?></strong></td>
      </tr>
    </table>
