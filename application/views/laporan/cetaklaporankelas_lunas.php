  ...
  <section class="sheet padding-10mm">
    <table>
      <tr>
        ...
        <td><h3 style="font-family:Tahoma">DAFTAR TUNGGAKAN KELAS <?php echo $kelas; ?><br>TAHUN AJARAN <?php echo $tahunajaran; ?><br></h3></td>
      </tr>
    </table>
      ...
      ?>
        <tr>
          ...
          if($lunas=="-"){
              ...
              $lunas="-";
    				?>
    					<td align="right" bgcolor="<?php echo $bgcolor; ?>"><strong><?php  echo $lunas;?></td>
    				<?php
    				}else{
    					$tung = 0;
              $lunas="-";
    			...
    			?>
    				<td align="right" bgcolor="<?php echo $bgcolor; ?>"><strong><?php  echo $lunas;?></strong></td>
    			<?php
    			}
