...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-md-6 col-xs12">
          <form class="form-horizontal" method="post" name="form_editrencana" id="form_editrencana">
              ...
              <?php
                ...
                foreach($ren as $r){
                  if ($r->cicilanke==0){
    					?>
        					<tr>
        						<td><input type="text" readonly="readonly" class="form-control" style="width:215px;" id="cicilanke<?php echo $n; ?>" name="cicilanke<?php echo $n; ?>" value="Registrasi"/></td>
                    <td><input type="text" class="form-control" style="width:100px;" id="jatuhtempo<?php echo $n; ?>" name="jatuhtempo<?php echo $n; ?>" value="<?php echo $r->jatuhtempo; ?>" readonly/></td>
                ...
                <tr>
                  ...
                  <td><input type="text" class="form-control" style="width:100px;" id="jatuhtempo<?php echo $n; ?>" name="jatuhtempo<?php echo $n; ?>" value="<?php echo $r->jatuhtempo; ?>"/ readonly></td>
                  <td align="right"><input type="text" class="form-control" style="width:150px;" id="wajibbayar<?php echo $n; ?>" name="wajibbayar<?php echo $n; ?>" value="<?php  echo $r->wajibbayar;?>" readonly/></td>
                </tr>
              <?php
                }
                $n++;
        ...
        <div class="col-md-6 col-xs12">
          <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>pembayaran/updaterencana2" name="form_editrencana" id="form_editrencana">
            <input type="hidden" name="id" value="<?php echo $id;?>"/>
    				<input type="hidden" name="rencanacicilan" value="<?php echo $rencanacicilan;?>"/>
            <table class="table table-striped table-hover">
      				<tr class="success">
