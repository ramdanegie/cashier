<form id="formregis" class="form-horizontal form-label-left input_mask" action="<?php echo base_url(); ?>pembayaran/insert_regis" method="POST">
<div class="row">
              ...
              <div class="x_content">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-9 col-sm-9 col-xs-12">
                    <input type="text" name="tglregis" id="tglregis" class="form-control" placeholder="Tanggal Registrasi">
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12">Harga Publish</label>
                  <div class="col-md-9 col-sm-9 col-xs-12">
                    <input type="hidden" name="kodebiaya" value="<?php echo $biaya['kodebiaya']; ?>">
                ...
                <div class="form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12">Dana Pinjaman</label>
                  <div class="col-md-9 col-sm-9 col-xs-12">
                    <input style="text-align:right" value="0" onkeyup="calc()"  name="danapinjaman" id="danapinjaman"  type="text" class="form-control">
                  </div>
                </div>
                <hr>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-9 col-sm-9 col-xs-12">
                    <input type="hidden" value="DANAPINJAMAN" name="keterangan" id="keterangan" class="form-control">
                  </div>
                </div>
...
<script>
  ...
  function calc(){
      ...
      dprupiah                = document.getElementById("danapinjaman").value;
      danapinjaman            = dprupiah.replace(/\./g,'');
      ...
      var deal    = parseInt(result)-(parseInt(jmlregis)+parseInt(danapinjaman));
  ...
  $(function(){
    ...
    $("#formregis").submit(function(){
        ...
        if(gelombang == ""){
           ...
           return false;
        }else if(hargadeal == 0 || hargadeal ==""){
           swal("Oops!", "Harga Deal Masih Kosong Cuy.. !", "warning");
           return false;
        }else if(registrasi == 0 || registrasi ==""){
           swal("Oops!", "Hmmm Registrasi Belum Diisi.. !", "warning");
           return false;
        }else if(registrasi == 0 || registrasi ==""){
           swal("Oops!", "Hmmm Registrasi Belum Diisi.. !", "warning");
           return false;
        }else if(jmlcicilan == 0 || jmlcicilan ==""){
           swal("Oops!", "Jumlah Cicilan Belum Diisi.. !", "warning");
           return false;
