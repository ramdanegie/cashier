...
if($kw['jenis']=='REGULER'){
  if($kw['tingkat']=="3"){
    $konelo="Pembayaran ". $kw['kodejur']. "untuk ". $kw['keterangan'];
  }else{
    $konelo="Pembayaran tingkat ". $kw['namatingkat']. "untuk ". $kw['keterangan'];
  }
...
<?php if($jn==""){
?>
<?php echo $kw['terimadari'];?> (No Induk :<?php echo $kw['nim'];?>, Kelas :<?php echo $kw['kelas'];?>)
<?php
}else if($jn=="II"){
echo $kw['terimadari'];
}
