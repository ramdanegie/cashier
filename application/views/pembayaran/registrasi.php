		...
		<div class="x_panel">
            ...
            <div class="x_panel">
              <div class="x_content">
                ...
                <div class="form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12">Penyesuaian</label>
                  <div class="col-md-9 col-sm-9 col-xs-12">
                    <input style="text-align:right" onkeyup="calc()" value="0"  type="text" name="peny" id="peny"  class="form-control" placeholder="Penyesuaian">
                  </div>
                </div>
                <hr>
                <div class="form-group">
...
<script>
  ...
  var p = document.getElementById('peny');
  ...
  function calc(){
      ...
      penyrupiah              = document.getElementById("peny").value;
      peny                    = penyrupiah.replace(/\./g,'');
      ...
      var result  = parseInt(hargapublish) - parseInt(potcash) - parseInt(potpres) - parseInt(potgel)-parseInt(potlainlain)+parseInt(peny);
