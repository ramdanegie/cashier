...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-md-6 col-xs12">
          <form class="form-horizontal" action="<?php echo base_url(); ?>pembayaran/updaterencanapinjaman" method="post" name="form_editrencana" id="form_editrencana">
            ...
            <table class="table table-striped table-hover">
              ...
              <?php
                ...
                $jumlahsisa = 0;
                foreach($ren as $r){
                  $jumlahsisa = $jumlahsisa + $r->wajibbayar;
                  if ($r->cicilanke==0){
    					?>
        					<tr>
              ...
              $danapinjaman = $hd - $jumlahsisa;
              ?>
              <tr>
      					<td colspan="2" align="right">Jumlah Rencana Pembayaran</td>
      					<td align="right"><input type="text" readonly="readonly" class="form-control" name="jumlahsisa" value="<?php echo $jumlahsisa;?>  "/></td>
      				</tr>
              <tr>
                <td colspan="2" align="right">Dana Pinjaman</td>
                <td align="right"><input type="text" class="form-control" readonly name="danapinjaman" value="<?php echo $danapinjaman;?>  "/></td>
              </tr>
              <tr>
