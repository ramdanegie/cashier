<form class="form-horizontal form-label-left" id="cust_form" autocomplete="off"  action="<?php echo base_url(); ?>pembayaran/updatebayar" method="POST">
 <input id="kodekontrak" type="hidden" name="kodekontrak" value="<?php echo $hb['kodekontrak'];?>" readonly="readonly" >
